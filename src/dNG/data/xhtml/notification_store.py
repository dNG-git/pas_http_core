...
:since:  v0.2.00
		...
		if ("dNG.data.xhtml.NotificationStore" not in store): store['dNG.data.xhtml.NotificationStore'] = { }
		if (context not in store['dNG.data.xhtml.NotificationStore']): store['dNG.data.xhtml.NotificationStore'][context] = [ ]

		return NotificationStore(store['dNG.data.xhtml.NotificationStore'][context])
	#
