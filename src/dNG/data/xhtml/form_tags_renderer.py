...
from dNG.data.text.abstract_form_tags import AbstractFormTags
...
:since:  v1.0.0
        ...
        if (self.is_block_encoding_supported and len(_return) > 0):
            ...
            element_code = ("class='pagecontent_box pagecontent_box_left' style='clear: left; width: {0}'".format(tag_params['box'])
                            if ("box" in tag_params) else
...
:since:  v1.0.0
        ...
        if (self.is_block_encoding_supported and len(_return) > 0):
            ...
            element_code = ("class='pagecontent_box pagecontent_box_right' style='clear: right; width: {0}'".format(tag_params['box'])
                            if ("box" in tag_params) else
