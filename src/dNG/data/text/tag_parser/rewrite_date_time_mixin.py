...
:since:  v1.0.0
        ...
        if (self._log_handler is not None): self._log_handler.debug("#echo(__FILEPATH__)# -{0!r}.render_rewrite_date_time({1}, {2})- (#echo(__LINE__)#)", self, key, _type, context = "pas_tag_parser")
